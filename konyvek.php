...
$sql = "SELECT * FROM termekek WHERE tipus = 1 AND kifutott != 'igen'";
...
<form action = "index.php?oldal=konyvek" method = "post">
...
<div class = "termekek-egyben">
	...
	<div class = "termekek">
        ...
        <a href="index.php?oldal=termek&id=<?=$termek['id']?>&tipus=1" class="termek">
	...
	<div class="oldal-valto-gombok">
        ...
        <a href="index.php?oldal=konyvek&o=<?=$jelenlegi_oldal-1?>">Előző oldal</a>
        <?php endif; ?>
		<div class = "kovetkezo">
        <?php if ($termekek_osszesen > ($jelenlegi_oldal * $termekszam) - $termekszam + mysqli_num_rows($termekek)): ?>
        <a href="index.php?oldal=konyvek&o=<?=$jelenlegi_oldal+1?>">Következő oldal</a>
        <?php endif; ?>
		</div>
	</div>
</div>
